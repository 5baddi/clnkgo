...
@section('content')
<form action="{{ route('dashboard.responses.save') }}" method="POST">
    @csrf
    <div class="row row-cards">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create new canned response</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 mt-2">
                            ...
                            <input type="text" name="title" class="form-control @if($errors->has('title')) is-invalid @endif" value="{{ old('title') }}" placeholder="Title of canned response" autofocus  required/>
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <textarea rows="5" maxlength="{{ \BADDIServices\SourceeApp\App::TWEET_CHARACTERS_LIMIT }}" name="content" class="form-control @if($errors->has('content')) is-invalid @endif" placeholder="Canned response content" required>{{ old('content') }}</textarea>
