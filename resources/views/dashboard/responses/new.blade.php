                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <textarea rows="5" maxlength="{{ \BADDIServices\ClnkGO\App::TWEET_CHARACTERS_LIMIT }}" name="content" class="form-control @if($errors->has('content')) is-invalid @endif" placeholder="Canned response content">{{ old('content') }}</textarea>
