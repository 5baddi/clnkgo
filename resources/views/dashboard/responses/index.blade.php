        ...
        <div class="card mt-4">
          <div class="card-header">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('dashboard.responses.new') }}" class="btn btn-clnkgo d-none d-sm-inline-block">
                  ...
                  @foreach ($responses as $response)
                    <tr>
                        ...
                        <td class="text-center">
                          <a href="{{ route('dashboard.responses.edit', ['id' => $response->getId()]) }}" title="Edit" class="btn btn-icon btn-sm btn-clnkgo">
                          ...
                          <form action="{{ route('dashboard.responses.delete', ['id' => $response->getId()]) }}" method="POST" style="display: inline-block;">
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-icon btn-sm btn-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this canned response?')">
