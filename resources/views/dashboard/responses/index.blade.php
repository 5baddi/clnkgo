                  ...
                  @foreach ($responses as $response)
                    <tr>
                        ...
                        <td class="text-center">
                          <a href="{{ route('dashboard.responses.edit', ['id' => $response->getId()]) }}" class="btn btn-clnkgo">
                          ...
                          <form action="{{ route('dashboard.responses.delete', ['id' => $response->getId()]) }}" method="POST" style="display: inline-block;">
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this canned response?')">
