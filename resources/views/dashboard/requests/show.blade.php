        ...
        <div class="card card-link">
            ...
            <div class="card-footer d-flex justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <svg @if($tweet->author->location)style="margin-left: 2rem !important;"@endif xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-world" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <a href="//{{ url($tweet->author->website) }}" target="_blank" title="Website">{{ $tweet->author->website }}</a>
                    @endif
