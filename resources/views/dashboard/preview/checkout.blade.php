    ...
    <body data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="overflow: visible; height: auto;">
                                                        ...
                                                        <div class="text-container">
                                                            <ul class="payment-method-list"
                                                                ...
                                                                <li class="payment-method-list__item"
                                                                    ...
                                                                    <div style="width: 100%;">
                                                                        <a
                                                                            style="color: #40ABEE; font-weight: 600; display: inline-block; padding: 8px 15px 8px 12px; background-color: #1d9bf0; border-radius: 30px; cursor: pointer; width: 88%;"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (el && el !== 'undefined') {
                    el.style.color = color || '{{ \BADDIServices\SourceeApp\Models\Setting::DEFAULT_COLOR }}';
                }
