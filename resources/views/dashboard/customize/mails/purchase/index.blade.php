    ...
    <td align="center">
        ...
        <table>
            <tbody><tr>
                ...
                <td style="width: 120px; text-align: center; padding-right: 5px;">
                    <div style="width: 85%;">
                        <a href="#" style="text-decoration: none; color: #40ABEE; font-weight: 600; display: inline-block; padding: 8px 15px 8px 12px; background-color: #1d9bf0; border-radius: 30px; cursor: pointer; width: 88%;">
