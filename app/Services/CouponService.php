...
class CouponService extends Service
{
    public function getScriptTag(float $discount = Setting::DFEAULT_DISCOUNT, string $type = Setting::FIXED_TYPE, string $currency = Setting::DEFAULT_CURRENCY, $color = Setting::DEFAULT_COLOR)
    {
        $html = '<div id="app-affiliate-section" class="section__content srow" style="display:none;">
            ...
            <div class="text-container">
                <ul class="payment-method-list" style="text-align: right; margin-left: 25px;">
                    ...
                    <li class="payment-method-list__item" style="text-align: center; ">
                        <div style="width: 100%;"><a style="color: #40ABEE; font-weight: 600; display: inline-block; padding: 8px 15px 8px 12px; background-color: #1d9bf0; border-radius: 30px; cursor: pointer; width: 88%;" onclick="window.shareTwitter()"><svg xmlns="http://www.w3.org/2000/svg" style="width: 20px; margin-top: -5px; margin-right: 4px; display: inline-block; vertical-align: middle; " class="icon icon-tabler icon-tabler-brand-twitter" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div id="offer-details"
            ...
            <div
                style="background-color: #ffffff; text-align: center; color: #1d9bf0; font-size: 18px; padding: 15px 25px; width: 320px;">
